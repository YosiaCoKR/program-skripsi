...
- Workspace ID: `97b97812-527b-46e2-97f6-fb87d7b234c3`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/97b97812-527b-46e2-97f6-fb87d7b234c3.
...
2. `npx ngodingpakeai connect --workspace 97b97812-527b-46e2-97f6-fb87d7b234c3 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/97b97812-527b-46e2-97f6-fb87d7b234c3. Only pass on links the CLI actually printed — never assemble one from an id yourself.
